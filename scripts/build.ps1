...
foreach ($required in @('ItemStatsSystem.dll', 'TeamSoda.Duckov.Core.dll', 'TeamSoda.Duckov.Utilities.dll', 'UnityEngine.CoreModule.dll', 'UnityEngine.ImageConversionModule.dll')) {
